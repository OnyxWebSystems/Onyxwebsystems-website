...
async function main() {
  ...
  await prisma.partnerResearchSource.deleteMany();
  await prisma.partnerResearch.deleteMany();
  await prisma.partnerOutreach.deleteMany();
  await prisma.partnerNote.deleteMany();
  await prisma.partnerActivity.deleteMany();
  await prisma.partner.deleteMany();
  await prisma.partnerEngineSettings.deleteMany();
  ...
  await prisma.partnerEngineSettings.create({
    data: {
      organizationId: org.id,
      ...
      minPartnerScore: 70,
      minClientValueScore: 70,
      defaultCommissionBps: 1000,
      minProjectValueCents: 400000,
    },
  });
  ...
  const seedPartners = [
    {
      ...
      whyGoodFit: "They advise growing businesses on operations; Onyx can implement the systems those clients need.",
      potentialClientProfile: "Established SMEs leaving spreadsheets and disconnected tools behind.",
      recommendedPitch: "You handle strategy; Onyx handles implementation.",
    },
    {
      ...
      targetClientSize: null as string | null,
    ...
    },
    {
      ...
      primaryContactRole: null as string | null,
      primaryContactEmail: null as string | null,
      primaryContactLinkedin: null as string | null,
      contactPageUrl: null as string | null,
      status: "DISCOVERED",
      ...
      whyGoodFit: null as string | null,
      potentialClientProfile: null as string | null,
      recommendedPitch: null as string | null,
    },
  ];

  for (const row of seedPartners) {
